...
`r if(file.exists("01-raw-data/clickstream/clickstream_data.csv")){"*  _clickstream_data.csv_"}` with `r nrow(read.csv("01-raw-data/clickstream/clickstream_data.csv", header=TRUE, sep=",", stringsAsFactors=FALSE))` entries
