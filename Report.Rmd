...
In this way, we were able to discover that it is possible to join on the 'Customer ID' for some instances. Thereby, we saved a dataset for the merging results on the Customer ID:

```{python pythonMerging, eval=F}
import pandas as pd
