...
Since the training set is created by using random samples, model performance can vary during each run. However, on average the accuracy should be around 89% and the F1 score at around 94%. Also, on average the most important features are the number of clicks and the session duration. 
