...
*Note: For the lorenz curves we dropped the x-axis tick labels for a better readability. For details see the top attributes for products in the [summary tables](#sumTabs).*
