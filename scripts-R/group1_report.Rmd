...
author: "Julian Cornea, Kim Ferres, Jan L??ffelmann"
date: "23-05-2019"
output:
...
p3 <- beautify(p3)
p4 <- meanOverTime(orders,"Order.Line.Date","Order.Line.Amount","?? Amount in $") +
      theme_classic() +
      ggtitle("History of Average Order Amount")
p4 <- beautify(p4)
p5 <- meanOverTime(orders,"Order.Line.Date","Order.Line.Unit.List.Price","?? Price in $") +
      theme_classic() +
      ggtitle("History of Average Unit List Price")
p5 <- beautify(p5)
p6 <- meanOverTime(orders,"Order.Line.Date","Order.Line.Quantity","?? Quantity") +
      theme_classic() +
